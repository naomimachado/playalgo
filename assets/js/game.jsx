...
function GameInstance(params) {
  <div className="col-6 game-item" onClick={() =>
    params.challenge_guess_your_opponent(item.game_name, document.getElementById("player-name").value, document.getElementById("challenge").value)}>
     item.game_name
  </div>
}
